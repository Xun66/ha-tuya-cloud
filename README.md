...
After setup, Home Assistant shows the meter as one device with separate
channel 1 and channel 2 sensors.
...
Contributions are welcome. Device reports, Tuya shadow payload samples, sensor
mapping fixes, documentation improvements, and support for additional compatible
meters are all appreciated.
